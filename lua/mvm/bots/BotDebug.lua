    ...
    Event.Hook( string.format("Console_bot_%s", varName),
            function(client, value)
                if value == nil then
                    ...
                    self.vars[varName] = (varName == "true" or varName == "1")
                end
...
Event.Hook(
	"Console_bot_hotload", 
	function()
        Script.Load("lua/mvm/bots/BotMarineBrain_Data.lua", true)
        Script.Load("lua/mvm/bots/BotMarineCommanderBrain_Data.lua", true)
        //Script.Load("lua/mvm/bots/SkulkBrain_Data.lua", true)
