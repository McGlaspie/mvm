...
RegisterVoteType("MvM_VoteRandomizeRR", { })
...
if Client then
    ...
    local function SetupRandomizeRRVote(voteMenu)
        ...
        local function StartRandomizeRRVote(data)
            AttemptToStartVote("MvM_VoteRandomizeRR", { })
        end
        ...
        AddVoteStartListener("MvM_VoteRandomizeRR", GetVoteRandomizeRRQuery)
...
if Server then
    ...
    SetVoteSuccessfulCallback("MvM_VoteRandomizeRR", kExecuteVoteDelay, OnRandomizeRRVoteSuccessful)
