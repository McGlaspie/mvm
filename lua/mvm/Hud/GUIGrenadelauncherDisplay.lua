...
function GUIGrenadelauncherDisplay:Initialize()
    ...
    self.viewPitch:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    for i = 1, kNumGrenades do
        ...
        grenadeIcon:SetShader("shaders/GUI_TeamThemed.surface_shader")
...
function GUIGrenadelauncherDisplay:UpdateTeamColors()
	...
	for i = 1, kNumGrenades do
		...
		grenadeIcon:SetFloatParameter( "teamBaseColorR", ui_color.r )
		grenadeIcon:SetFloatParameter( "teamBaseColorG", ui_color.g )
		grenadeIcon:SetFloatParameter( "teamBaseColorB", ui_color.b )
...
function GUIGrenadelauncherDisplay:SetTeamNumber(team)
