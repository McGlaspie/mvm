...
local kEndIconTextures = { [kEndStates.AlienPlayerWin] = "ui/marine_team2_victory.dds",
                           [kEndStates.MarinePlayerWin] = "ui/marine_victory.dds",
                           [kEndStates.AlienPlayerLose] = "ui/marine_defeat.dds",
...
local kMessageFontName = { 
	marine = "fonts/AgencyFB_huge.fnt", 
	//alien = "fonts/Stamp_huge.fnt" 
	alien = "fonts/AgencyFB_huge.fnt"
}
local kMessageText = { [kEndStates.AlienPlayerWin] = "GOLD TEAM WINS",
                       [kEndStates.MarinePlayerWin] = "BLUE TEAM WINS",
                       [kEndStates.AlienPlayerLose] = "GOLD TEAM DEFEATED",
                       [kEndStates.MarinePlayerLose] = "BLUE TEAM DEFEATED" }
                       
//Why local? Why not just refernce global...?
local kMessageWinColor = { 
	marine = kMarineFontColor, 
	alien = kAlienFontColor 
}
local kMessageLoseColor = { 
	marine = Color(0.2, 0, 0, 1), 
	alien = Color(0.2, 0, 0, 1) 
}
