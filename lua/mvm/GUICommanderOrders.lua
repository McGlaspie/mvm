...
local kOrderCinematic = {
    [kTeam1Index] = PrecacheAsset("cinematics/marine/order.cinematic"),
    [kTeam2Index] = PrecacheAsset("cinematics/alien/order.cinematic")
}

local kOrderLineColor = {
    [kTeam1Index] = Color(kMarineTeamColorFloat.r, kMarineTeamColorFloat.g, kMarineTeamColorFloat.b, 0.5),
    [kTeam2Index] = Color(kAlienTeamColorFloat.r, kAlienTeamColorFloat.g, kAlienTeamColorFloat.b, 0.5)
}
...
local function UpdateLine(startPoint, endPoint, guiItem, teamNumber)
    ...
    guiItem:SetColor( kOrderLineColor[teamNumber] )
...
function GUICommanderOrders:Update(deltaTime)
    ...
    UpdateOrderList(self.orders, newOrdersNum, teamNumber)
    ...
    for i = 1, newOrdersNum do
        ...
        if showLine then
            ...
            UpdateLine( prevScreenPosition, screenPosition, orderItem.Line, teamNumber )        
