    ...
    for i=1, #kOtherTypes do
        ...
        for index, other in ientitylist(others) do
            ...
            if relevant then
                ...
                //XXX Will probably have to updat below
                ...
                local color = kHealthBarColors[other:GetTeamNumber()]
                //local color = ConditionalValue( other:GetTeamNumber() == kTeam2Index, kRedColor, kBlueColor )
                ...
                otherGUI.HealthBar:SetColor(color)
...
function GUIInsight_OtherHealthbars:CreateOtherGUIItem()
    ...
    return { 
		...
		HealthBar = otherHealthBar, 
		HealthChangeBar = otherHealthChangeBar, 
		StoredValues = {HealthFraction = -1} 
	}
