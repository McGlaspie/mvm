...
if PlayerUI_GetTeamNumber() == kTeam1Index then
	...
	GUIMarineHUD.kInitSquareColors = Color( kBrightColorTeam1.r, kBrightColorTeam1.g, kBrightColorTeam1.b , 0.3)
else
	GUIMarineHUD.kInitSquareColors = Color( kBrightColorTeam2.r, kBrightColorTeam2.g, kBrightColorTeam2.b, 0.3)
end
...
GUIMarineHUD.kMinimapBorderTextureCoords = { 
	GUIMarineHUD.kMinimapBackgroundTextureCoords[3], 
	GUIMarineHUD.kMinimapBackgroundTextureCoords[4], 
	2 * GUIMarineHUD.kMinimapBackgroundTextureCoords[3], 
	2 * GUIMarineHUD.kMinimapBackgroundTextureCoords[4] 
}
GUIMarineHUD.kMinimapBackgroundSize = Vector( 
	GUIMarineHUD.kMinimapBackgroundTextureCoords[3] - GUIMarineHUD.kMinimapBackgroundTextureCoords[1], 
	GUIMarineHUD.kMinimapBackgroundTextureCoords[4] - GUIMarineHUD.kMinimapBackgroundTextureCoords[2], 0 
)
GUIMarineHUD.kMinimapPowerTextureCoords = { 
	0, GUIMarineHUD.kMinimapBackgroundTextureCoords[4] * 4, 
	43, 
	GUIMarineHUD.kMinimapBackgroundTextureCoords[4] * 4 + 28 
}
GUIMarineHUD.kMinimapScanlineTextureCoords = { 0, 0, 400, 128 }

GUIMarineHUD.kMinimapScanTextureCoords = { 
	GUIMarineHUD.kMinimapBackgroundTextureCoords[3], 
	2 * GUIMarineHUD.kMinimapBackgroundTextureCoords[4], 
	2 * GUIMarineHUD.kMinimapBackgroundTextureCoords[3], 
	3 * GUIMarineHUD.kMinimapBackgroundTextureCoords[4] 
}


GUIMarineHUD.kMinimapStencilTextureCoords = { 
	GUIMarineHUD.kMinimapBackgroundTextureCoords[3], 
	3 * GUIMarineHUD.kMinimapBackgroundTextureCoords[4], 
	2 * GUIMarineHUD.kMinimapBackgroundTextureCoords[3], 
	4 * GUIMarineHUD.kMinimapBackgroundTextureCoords[4] 
}

GUIMarineHUD.kMinimapPowerSize = Vector(
	GUIMarineHUD.kMinimapPowerTextureCoords[3] - GUIMarineHUD.kMinimapPowerTextureCoords[1], 
	GUIMarineHUD.kMinimapPowerTextureCoords[4] - GUIMarineHUD.kMinimapPowerTextureCoords[2], 
	0
)
...
function GUIMarineHUD:Initialize()
    ...
    self.scanLeft:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.scanRight:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.armorLevel:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.weaponLevel:SetShader("shaders/GUI_TeamThemed.surface_shader")
...
function GUIMarineHUD:InitFrame()
    ...
    self.topLeftFrame:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.topRightFrame:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.bottomLeftFrame:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.bottomRightFrame:SetShader("shaders/GUI_TeamThemed.surface_shader")
...
function GUIMarineHUD:InitializeMinimap()
    ...
    self.minimapBackground:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.minimapStencil:SetShader("shaders/GUI_TeamThemed.surface_shader")
    self.minimapBackground:AddChild(self.minimapStencil)
    
    self.minimapScript = GetGUIManager():CreateGUIScript("mvm/GUIMinimapFrame")
    ...
    self.minimapScanLines:SetShader("shaders/GUI_TeamThemed.surface_shader")
...
function GUIMarineHUD:TriggerInitAnimations()
    ...
    for i = 1, GUIMarineHUD.kNumInitSquares do
        ...
        if PlayerUI_GetTeamNumber() == kTeam1Index then
			animatedSquare:SetColor( Color( kBrightColorTeam1.r, kBrightColorTeam1.g, kBrightColorTeam1.b , 0.3) )
		else
			animatedSquare:SetColor( Color( kBrightColorTeam2.r, kBrightColorTeam2.g, kBrightColorTeam2.b, 0.3) )
		end
...
function GUIMarineHUD:UpdateHudColors()
	...
	self.topLeftFrame:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.topLeftFrame:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.topLeftFrame:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
    self.topRightFrame:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.topRightFrame:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.topRightFrame:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
	
    self.bottomLeftFrame:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.bottomLeftFrame:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.bottomLeftFrame:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
    self.scanLeft:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.scanLeft:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.scanLeft:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
    self.scanRight:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.scanRight:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.scanRight:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
	self.armorLevel:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.armorLevel:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.armorLevel:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
	
	self.weaponLevel:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
