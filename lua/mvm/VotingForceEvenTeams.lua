...
RegisterVoteType("MvM_VotingForceEvenTeams", { })
...
if Client then
    ...
    local function SetupForceEvenTeamsVote(voteMenu)
        ...
        local function StartForceEvenTeamsVote(data)
            AttemptToStartVote("MvM_VotingForceEvenTeams", { })
        end
        ...
        AddVoteStartListener("MvM_VotingForceEvenTeams", GetVoteForceEvenTeamsQuery)
...
if Server then
    ...
    SetVoteSuccessfulCallback("MvM_VotingForceEvenTeams", kExecuteVoteDelay, OnForceEvenTeamsVoteSuccessful)
