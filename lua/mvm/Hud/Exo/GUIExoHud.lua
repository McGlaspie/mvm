...
local function UpdateTargets(self)
    ...
    local trackEntities = GetEntitiesWithinRange("Alien", PlayerUI_GetOrigin(), kTrackEntityDistance)	//FIXME Update for opposite team Marines
    ...
    for t = 1, #trackEntities do
        ...
        if inFront and trackEntity:GetIsAlive() and trackEntity:isa("Marine") and not trackEntity:GetIsCloaked() then
