...
// This now operates using Team Numbers.
//
//
...
kMarineTeam1MobileTargets = MobileTargetType():Init( "MarineTeam1Mobile", kTeam1Index, MobileTargetMixin.type )
kMarineTeam1StaticTargets = StaticTargetType():Init( "MarineTeam1Static", kTeam1Index, StaticTargetMixin.type )

kMarineTeam2MobileTargets = MobileTargetType():Init( "MarineTeam2Mobile", kTeam2Index, MobileTargetMixin.type )
kMarineTeam2StaticTargets = StaticTargetType():Init( "MarineTeam2Static", kTeam2Index, StaticTargetMixin.type )
...
TargetType.kAllTargetTypes = {
    ...
    kMarineTeam1MobileTargets,
    kMarineTeam2StaticTargets, 
    kMarineTeam2MobileTargets
}
