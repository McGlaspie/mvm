...
kMarineStructureEffects = 
{
    ...
    ///*
    // Looping cinematic played when going through phase gate will teleport you somewhere
    phase_gate_linked_team2 =
    {
        pgLinkedEffects = 
        {
            // Play spin for spinning infantry portal
            {looping_cinematic = "cinematics/marine/phasegate/phasegate_team2.cinematic"},
            {parented_sound = "sound/NS2.fev/marine/structures/phase_gate_active"},
        },
    },
    
    phase_gate_unlinked_team2 =
    {
        pgLinkedEffects = 
        {
            // Destroy it if not spinning
            {stop_sound = "sound/NS2.fev/marine/structures/phase_gate_active"},
            {stop_cinematic = "cinematics/marine/phasegate/phasegate_team2.cinematic", done = true},            
        },
    },
    //*/
