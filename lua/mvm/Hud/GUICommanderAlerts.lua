...
function GUICommanderAlerts:Uninitialize()
    ...
    self.teamType = 0	//FIXME doesn't work...
    self.teamNumber = 0
...
function GUICommanderAlerts:AddMessage(text, iconXOffset, iconYOffset, entityId, mapX, mapZ)
    ...
    insertMessage["Icon"]:SetShader("shaders/GUI_TeamThemed.surface_shader")
    insertMessage["Icon"]:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    insertMessage["Icon"]:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    insertMessage["Icon"]:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    ...
    insertMessage["Icon"]:SetColor( kIconColors[self.teamNumber] )
    ...
    insertMessage["Message"]:SetColor( 
		ConditionalValue( playerTeam == kTeam1Index, kMarineFontColor, kAlienFontColor ) 
	)
    ...
    insertMessage["Background"]:SetShader("shaders/GUI_TeamThemed.surface_shader")
    insertMessage["Background"]:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    insertMessage["Background"]:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    insertMessage["Background"]:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
