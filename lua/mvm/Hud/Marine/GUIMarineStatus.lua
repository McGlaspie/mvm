...
//FIXME Update below? Leave to shader?
...
if PlayerUI_GetTeamNumber() == kTeam1Index then
	...
	GUIMarineStatus.kArmorBarColor = kBrightColorTeam2
	GUIMarineStatus.kHealthBarColor = kDarkColorTeam2
end
...
function GUIMarineStatus:Initialize()
    ...
    self.statusStencil:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.armorBar:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.healthBar:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.healthBorder:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.healthBorderMask:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.armorBorder:SetShader("shaders/GUI_TeamThemed.surface_shader")
    ...
    self.armorBorderMask:SetShader("shaders/GUI_TeamThemed.surface_shader")
...
function GUIMarineStatus:UpdateHudTeamColors()
    ...
    self.scanLinesForeground:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.scanLinesForeground:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.scanLinesForeground:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
    self.armorBar:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.armorBar:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.armorBar:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
	self.healthBar:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
	self.healthBar:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
	self.healthBar:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
	
    self.healthBorderMask:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.healthBorderMask:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.healthBorderMask:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
    self.healthBorder:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.healthBorder:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.healthBorder:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
    self.armorBorder:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.armorBorder:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.armorBorder:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
    self.armorBorderMask:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
    self.armorBorderMask:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
    self.armorBorderMask:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    
    //Yes, below effectively resets color every update. Any tweaks are covered in self:Update()
    //Not ideal, but works for now.
    self.healthBar:SetColor(
		ConditionalValue(
			playerTeam == kTeam1Index,
			kBrightestColorTeam1,
			kBrightColorTeam2
		)
	)
	self.healthText:SetColor(
