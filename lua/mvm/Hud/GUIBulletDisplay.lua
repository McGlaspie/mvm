...
function GUIBulletDisplay:Initialize()
    ...
    self.ammoTextBg:SetColor(Color(1, 1, 1, 0.4))	//a = 0.25
    ...
    for i =1,self.numClips do
        ...
        self.clip[i]:SetShader("shaders/GUI_TeamThemed.surface_shader")
...
function GUIBulletDisplay:UpdateTeamColors()
	...
	/*
	//below has gotta be bad...
	for i =1,self.numClips do
		self.clip[i]:SetFloatParameter( "teamBaseColorR", ui_color.r )
		self.clip[i]:SetFloatParameter( "teamBaseColorG", ui_color.g )
		self.clip[i]:SetFloatParameter( "teamBaseColorB", ui_color.b )
	end
	*/
end
...
function GUIBulletDisplay:SetTeamNumber( teamNumber )
