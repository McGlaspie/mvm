...
function UpdateOverHeat(dt, heatAmount, teamNumber)

    PROFILE("GUILeftMinigunDisplay:Update")
    
    foregroundMask:SetSize(Vector(242, 720 * (1 - heatAmount), 0))
    
    background:SetColor( kGUI_NameTagFontColors[teamNumber] )
    foreground:SetColor( kGUI_HealthBarColors[teamNumber] )
