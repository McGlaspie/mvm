...
function GUIPlayerResource:Initialize(style)
	...
	self.personalIcon:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
    ...
    self.personalText:SetColor(
		ConditionalValue(
			playerTeam == kTeam1Index,
			kBrightestColorTeam1,
			kBrightestColorTeam2
		)
	)
...
function GUIPlayerResource:UpdateTeamColors()
	...
	self.rtCount:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
	self.rtCount:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
	self.rtCount:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
	
	self.personalIcon:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
	self.personalIcon:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
	self.personalIcon:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
	
	self.personalText:SetColor( ConditionalValue( playerTeam == kTeam1Index, kBrightestColorTeam1, kBrightestColorTeam2 ) )
	
	//self.ResGainedText:SetColor( ConditionalValue( playerTeam == kTeam1Index, kBrightColorTeam1, kBrightestColorTeam2 ) )
