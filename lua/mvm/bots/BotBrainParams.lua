...
class "BotBotBrainParams"

function BotBrainParams:Initialize(brainName)
    self.brainName = brainName
    self.param2values = {}
end

function BotBrainParams:Get(paramName, defaultValue)

	PROFILE("BotBrainParams:Get")
...
//----------------------------------------
function BotBrainParams:Mutate(maxRelativeAmount)

	PROFILE("BotBrainParams:Mutate")
...
//  
//----------------------------------------
function BotBrainParams:SetToAverage(p1, p2)

	PROFILE("BotBrainParams:SetToAverage")
