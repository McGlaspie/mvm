...
function GUISensorBlips:UpdateAnimations(deltaTime)
	...
	*/
    ...
    for i, blip in ipairs(self.activeBlipList) do
		...
		blip.GraphicsItem:SetFloatParameter( "teamBaseColorR", ui_baseColor.r )
		blip.GraphicsItem:SetFloatParameter( "teamBaseColorG", ui_baseColor.g )
		blip.GraphicsItem:SetFloatParameter( "teamBaseColorB", ui_baseColor.b )
