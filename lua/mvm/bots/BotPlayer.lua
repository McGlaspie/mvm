...
Script.Load("lua/mvm/bots/BotMotion.lua")
Script.Load("lua/mvm/bots/BotMarineBrain.lua")
...
function BotPlayer:GetNamePrefix()
    return "[BOT] "
end

function BotPlayer:UpdateNameAndGender()
    ...
    if self.botSetName == nil and math.random() < .2 then
        ...
        // set gender
        self.client.variantData = {		//TODO Randomize among available variants
...
function BotPlayer:_LazilyInitBrain()
