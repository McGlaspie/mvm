    ...
    if localPlayer then
        ...
        if self.beacon:GetIsVisible() then
            ...
            local ui_baconColor = ConditionalValue(
				localPlayer:GetTeamNumber() == kTeam1Index,
				Color( kMarineTeamColorFloat.r, kMarineTeamColorFloat.g, kMarineTeamColorFloat.b, alpha ),
				Color( kAlienTeamColorFloat.r, kAlienTeamColorFloat.g, kAlienTeamColorFloat.b, alpha )
            )
            self.beacon:SetColor( ui_baconColor )
