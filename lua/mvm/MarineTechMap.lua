...
Script.Load("lua/mvm/TechTreeButtons.lua")	//needed?
...
kMarineTechMap =
{
        ...
        { kTechId.FlamethrowerTech, 2, 5.5 }, { kTechId.AdvancedArmory, 3.5, 5.5 },
        { kTechId.GrenadeLauncherTech, 2, 4.75 },
        ...
        { kTechId.ArmsLab, 9, 7 },
			{ kTechId.Weapons1, 10, 6.5 },{ kTechId.Weapons2, 11, 6.5 },{ kTechId.Weapons3, 12, 6.5 }, { kTechId.Weapons4, 13, 6.5 },
...
kMarineLines = 
{
    ...
    // nano shield:
    { 7, 4.5, 8, 4.5},
    //GetLinePositionForTechMap(kMarineTechMap, kTechId.NanoShieldTech, kTechId.CommandStation),
    // cat pack tech:
    { 7, 5.5, 8, 5.5},
