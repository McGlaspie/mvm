...
if Server then
    ...
    local kFreeSpawnTime = 60	//TODO Move to BalanceMisc.lua?
    ...
    function NS2Gamerules:OnCreate()
        ...
        // Create team objects
        self.team1 = self:BuildTeam(kMarineTeamType)
        self.team1:Initialize(kTeam1Name, kTeam1Index)
        
        self.team2 = self:BuildTeam(kMarineTeamType)
    ...
    function NS2Gamerules:ResetGame()
        ...
        //TEMP HACK
        //Ensure all nodes are socketed at game start
        for index, powerNode in ientitylist(Shared.GetEntitiesWithClassname("PowerPoint")) do
			powerNode:SetConstructionComplete()	//TODO Change to unsocketed / powered down
        end
        ...
        if self.timeToSendTechPoints == nil or Shared.GetTime() > self.timeToSendTechPoints then
            ...
            if spectators:GetSize() > 0 then
                ...
                for _, techpoint in ientitylist(Shared.GetEntitiesWithClassname("TechPoint")) do
                    ...
                    local message = BuildTechPointsMessage(techpoint, commandStructures, powerNodes)
    ...
    function NS2Gamerules:EndGame(winningTeam)
        ...
        if self:GetGameState() == kGameState.Started then
            ...
            self.spectatorTeam:ForEachPlayer(function(player) Server.SendNetworkMessage(player, "GameEnd", { win = losingTeam:GetTeamType() == kTeam2Index }, true) end)
