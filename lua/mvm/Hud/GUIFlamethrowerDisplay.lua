...
function GUIFlamethrowerDisplay:UpdateTeamColors()
	...
	self.clipDisplay:SetFloatParameter( "teamBaseColorR", kGUI_NameTagFontColors[self.teamNumber].r )
	self.clipDisplay:SetFloatParameter( "teamBaseColorG", kGUI_NameTagFontColors[self.teamNumber].g )
	self.clipDisplay:SetFloatParameter( "teamBaseColorB", kGUI_NameTagFontColors[self.teamNumber].b )
...
function GUIFlamethrowerDisplay:SetTeamNumber(team)
